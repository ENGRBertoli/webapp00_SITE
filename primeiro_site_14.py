...
def Grafico_Barra_Status_Vertical(rotulos, quantias, cores, Largura=8, Altura=4, Titulo_Grafico='Gráfico de Barra', Titulo_x='Status', Titulo_y='Quantidade'):
    fig, ax = plt.subplots(figsize=(Largura, Altura))  # Altura reduzida para 4
        ...
        if not balancas:
            ...
            for balanca in balancas:
                ...
                Grafico_Barra_Status_Vertical(
                    ...
                    Largura=8,
                    Altura=4,  # Altura ajustada aqui também

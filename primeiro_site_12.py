...
# Função para exportar dados para Excel em BytesIO
...
def main():
    ...
    if menu == "Adicionar Balança":
        ...
        if st.button("Exportar Produtos"):
            ...
            st.download_button("Baixar Produtos", arquivo_produtos, file_name="produtos.xlsx")
        ...
        if st.button("Exportar Clientes"):
            ...
            st.download_button("Baixar Clientes", arquivo_clientes, file_name="clientes.xlsx")
